    ...
    <section className="py-20 sm:py-32 bg-gradient-to-br from-primary via-blue-600 to-purple-600 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Trust Indicators - Updated Style */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            <div className="flex items-center space-x-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white">카드 등록 불필요</span>
            </div>
            <div className="flex items-center space-x-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-sm font-medium text-white">영구 무료</span>
            </div>
            <div className="flex items-center space-x-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-sm font-medium text-white">언제든 취소 가능</span>
            </div>
          </div>
        </div>
      </div>
