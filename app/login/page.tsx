      ...
      <div className="w-full max-w-md">
        ...
        <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-2xl p-8 border border-white/20 dark:border-gray-700/20">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 mb-4 border-2 border-primary bg-white dark:bg-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-all shadow-md hover:shadow-lg"
          >
